...
public class QLKH extends javax.swing.JFrame {
    ...
    public void showDL() {
        try {
            ...
            while (rs114.next()) {
                ...
                vtor.add(rs114.getString("MaKH"));
                vtor.add(rs114.getString("TenKH"));
                vtor.add(rs114.getString("Gioitinh"));
                vtor.add(rs114.getString("SDT"));
                vtor.add(rs114.getString("Gmail"));
                vtor.add(rs114.getString("Diachi"));
    ...
    private void jButton74ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton74ActionPerformed
        QLTaiKhoan tk114 = new QLTaiKhoan();
    ...
    private void jButton76ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton76ActionPerformed
        QLNCC ncc114 = new QLNCC();
        ncc114.setVisible(true);
        dispose();
    ...
    private void themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themActionPerformed
        if (makhachhang.getText().equals("") || tenkhach.getText().equals("")) {
            ...
            try {
                Connection con114 = JDBCConnection.getJDBCConnection();
                PreparedStatement ps114 = con114.prepareStatement("insert into KhachHang values (?,?,?,?,?,?)");
                ps114.setString(1, makhachhang.getText());
                ps114.setString(2, tenkhach.getText());
                ps114.setString(3, cbgt.getSelectedItem().toString());
                ps114.setString(4, sdt.getText());
                ps114.setString(5, mail.getText());
                ps114.setString(6, dc.getText());
                ps114.executeUpdate();
                showDL();
    ...
    private void xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_xoaActionPerformed
       if (makhachhang.getText().isEmpty()) {
            ...
            try {
                Connection con114 = JDBCConnection.getJDBCConnection();
                PreparedStatement ps114 = con114.prepareStatement("delete from KhachHang where MaKH=?");
                ps114.setString(1, makhachhang.getText());
                ps114.executeUpdate();
                showDL();
            } catch (Exception e) {
    ...
    private void KhachHangTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_KhachHangTableMouseClicked
        DefaultTableModel model114 = (DefaultTableModel) KhachHangTable.getModel();
        int Myindex = KhachHangTable.getSelectedRow();
        makhachhang.setText(model114.getValueAt(Myindex, 0).toString());
        tenkhach.setText(model114.getValueAt(Myindex, 1).toString());
         sdt.setText(model114.getValueAt(Myindex, 2).toString());
         mail.setText(model114.getValueAt(Myindex, 3).toString());
        dc.setText(model114.getValueAt(Myindex, 4).toString());
